"""
Arquivo: airports_builder.py

Esse código cria um CSV utilizado para analisar dados dos aeroportos,
ou seja, nossos vértices.

Para cada aeroporto temos:
- ICAO
...
A biblioteca airportsdata ajuda a mapear as regiões de cada ICAO.

No fim do documento também tratamos pontualmente os ICAOs e aeroportos 
não contemplados por essa lib.
"""
...
# Remove duplicatas por ICAO caso existam
...
# Exporta
result.to_csv(f'{c.out_path}airports.csv', index=False)